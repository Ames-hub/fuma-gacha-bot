...
async def show_card(request: Request, card_id:str, token: str = Depends(require_valid_token)):
...
async def get_card(request: Request, card_id:str, token: str = Depends(require_valid_token)):
    card = dbcards.view_card(name=card_id)[0]
...
async def get_cards(request: Request, token: str = Depends(require_valid_token)):
...
async def del_card(request: Request, data: DelCardData, token: str = Depends(require_valid_token)):
...
async def set_pullable(request: Request, data: PullableData, token: str = Depends(require_valid_token)):
...
async def manage_card(request: Request, card_id:str, token: str = Depends(require_valid_token)):
