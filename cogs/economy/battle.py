...
@lightbulb.command(name='battle', description="Earn some pokecoins and a card!")
    ...
    if not failed:
        ...
        if money_gained == 10:
            if splash_randomizer == 1:
                splash_text = "You fought hard, fumbling around cluelessly and won on pure dumb luck, earnt 10 pokecoins."
            elif splash_randomizer == 2:
                splash_text = "You sent out your pokemon and it immediately tripped over its tail and died on the spot. Your opponent gave you 10 pokecoins out of pity."
            elif splash_randomizer == 3:
                splash_text = "You tried to send out your pokemon but accidentally hit the back of your head and knocked some pokecoins out of your hat and got 10 coins!"
        elif money_gained > 10 and money_gained <= 30:
            if splash_randomizer == 1:
                splash_text = f"You fought hard, and lost! but your opponent gave you {money_gained} pokecoins out of a mild respect for your skill."
            elif splash_randomizer == 2:
                splash_text = (f"You almost lost the battle, but at the last moment, "
                               ...
                               f"solid blow. You won {money_gained} pokecoins!")
            elif splash_randomizer == 3:
                splash_text = f"You both put a bet on who'd win a fight, and your opponents pokemon refused to fight! They had to give you {money_gained} pokecoins by default."
        elif money_gained > 30 and money_gained <= 60:
            if splash_randomizer == 1:
                splash_text = f"You fought well, and won! Your opponent gave you a good fight, and the opponent gave you {money_gained} pokecoins for your skill."
            elif splash_randomizer == 2:
                splash_text = f"You lured your opponent into a trap during a fight, and won the fight bet, earning you {money_gained} pokecoins!"
            elif splash_randomizer == 3:
                splash_text = (f"You stared awkwardly at your opponent's pokemon uncomfortably for a while, "
                               f"and it gave up out of social anxiety. You stole {money_gained} pokecoins from its wallet.")
        elif money_gained > 60 and money_gained < 100:
            if splash_randomizer == 1:
                splash_text = (f"You fought a fair and honest battle, and your opponent lost. "
                               f"They were so amazed by your battle honor, that they gave you {money_gained} pokecoins for it!")
            elif splash_randomizer == 2:
                splash_text = ("You were fighting when you realized a weakness in your opponent's pokemon, and exploited it. "
                               f"They commended you for your keen observation and gave you {money_gained} pokecoins.")
            elif splash_randomizer == 3:
                splash_text = (f"You had a good time fighting and laughed with your opponent, they far outmatched you however and you lost. "
                               f"They gave you {money_gained} pokecoins because they really liked you!")
        elif money_gained >= 100 and money_gained < 150:
            if splash_randomizer == 1:
                splash_text = ("You glared at your opponents pokemon like the Gigachad you are, "
                               f"and it decided not to oppose you out of respect, and gave you {money_gained} pokecoins for your respectableness.")
            elif splash_randomizer == 2:
                splash_text = ("You commanded your pokemon in its fight with a strong smile and pure efficiency, arms crossed, and won. "
                               f"Your opponent paid you {money_gained} pokecoins for existing and saluted you.")
            elif splash_randomizer == 3:
                splash_text = ("You fought hard against a thief with 3 pokemon with your single pokemon. "
                               ...
                               f"They gave you {money_gained} pokecoins to persuade you to not call the cops.")
            ...
            if splash_randomizer == 1:
                ...
                splash_text = ("You stood forth to oppose the opposer, and almost hammered your opponent into the ground, but stopped right before the impact. "
                               f"Your opponent, seeing it was no match, gave up and gave you {money_gained} pokecoins out of propitiation.")
            elif splash_randomizer == 3:
                splash_text = ("You looked at your opponent before the battle had even thought to begin, and they walked away. The concept of the battle also walked away. "
                               ...
                               f"They desperately fund raised {money_gained} pokecoins and gave it to you out of fear.")
        else:
            splash_text = "SPLASH_TEXT_ERROR"

        user_account.pokecoins.modify_balance(money_gained, operator="+")
    else:
        splash_text = ("You threw a rat at Arceus (God of Gods) and barely got away with it, and only because it let you. "
                       f"You had to offer {money_gained // 2} pokecoins to its shrine for its forgiveness.")
        user_account.pokecoins.modify_balance(money_gained // 2, operator="-")
