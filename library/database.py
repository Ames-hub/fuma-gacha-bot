...
class dbcards:
    ...
    def get_assosciations(card_id:str, expected_card_tier:int=None):
        card_tier = dbcards.get_tier(card_id, as_number=True)
    ...
    def assosciate_card(event_name, card_id):
        with sqlite3.connect(DB_PATH) as conn:
            try:
                ...
                logging.error(err, exc_info=err)
                conn.rollback()
                raise stdn_events.EventCardAssosciationError()
    ...
    def create(name, onetime):
        with sqlite3.connect(DB_PATH) as conn:
            try:
                ...
                conn.rollback()
                raise stdn_events.EventExistingError()
    ...
    def schedule(name, start_time, end_time):
        ...
        with sqlite3.connect(DB_PATH) as conn:
            ...
            if not is_schedulable:
                raise stdn_events.NotSchedulable()
            ...
            try:
                ...
                conn.rollback()
                raise stdn_events.EventSchedulingError()
...
class lmtd_events:
    ...
    def assosciate_card(event_name, card_id):
        with sqlite3.connect(DB_PATH) as conn:
            try:
                ...
                logging.error(err, exc_info=err)
                conn.rollback()
                raise lmtd_events.LimEventCardAssosciationError()
    ...
    def create(name):
        with sqlite3.connect(DB_PATH) as conn:
            try:
                ...
                conn.rollback()
                raise lmtd_events.LimEventExistingError()
    ...
    def schedule(name, start_time, end_time):
        ...
        with sqlite3.connect(DB_PATH) as conn:
            ...
            if not is_schedulable:
                raise lmtd_events.NotSchedulable()
            ...
            try:
                ...
                conn.rollback()
                raise lmtd_events.LimEventSchedulingError()
